...
if(isset($_POST['cpf'])){
    $factory = (new Factory())->withDatabaseUri(''
        . 'https://digitalprecadastro.firebaseio.com/');
$database = $factory->createDatabase();
$novoContato = [
    'CPF' => $_POST['cpf'],
    'PrimeiroNome' => $_POST['pnome'],
    'UltimoNome' => $_POST['unome'],
    'Email' => $_POST['email'],
    'Mae' => $_POST['mae'],
    'Pai' => $_POST['pai'],
    'DatadeNascimento' => $_POST['dtnasc']
];
$database->getReference('contatos/' . $_POST['cpf'])->set($novoContato);
$msg = 'Contato Adiciona com Sucesso';
}
                    ...
                    <form class="needs-validation" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="pnome" class="form-control" id="firstName" placeholder="" value="" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="unome" class="form-control" id="lastName" placeholder="" value="" required>
                                <div class="invalid-feedback">
                                    Campo obrigatório
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="cpf" class="form-control" id="address" placeholder="123.456.789-00" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="mae"  class="form-control" id="address" placeholder="Nome da Mãe" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="pai" class="form-control" id="address" placeholder="Nome do Pai" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="dtnasc" class="form-control" id="datapicker" placeholder="" required>
                                <div class="invalid-feedback">
